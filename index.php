            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle title" id="navbarDropdownMenuLink" data-toggle="dropdown"
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                  <a class="dropdown-item" href="">Trồng răng Implant</a>
                  <a class="dropdown-item" href="">Bọc răng sứ</a>
                  <a class="dropdown-item" href="">Trồng răng Implant</a>
                  <a class="dropdown-item" href="">Trồng răng sứ</a>
                  <a class="dropdown-item" href="">Niềng răng thẩm mỹ</a>
                  <a class="dropdown-item" href="">Cạo vôi răng</a>
                  <a class="dropdown-item" href="">Trám răng</a>
                  <a class="dropdown-item" href="">Điều trị tủy răng</a>
                  <a class="dropdown-item" href="">Nhổ răng</a>
                  <a class="dropdown-item" href="">Phẩu thuật tạo hình nứu</a>
                  <a class="dropdown-item" href="">Tẩy trắng răng</a>
                  <a class="dropdown-item" href="">Tiểu phẩu răng khôn</a>
                </div>
            </li>
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle title" id="navbarDropdownMenuLink12" data-toggle="dropdown"
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                  <a class="dropdown-item" href="">Bảng giá Implant</a>
                  <a class="dropdown-item" href="">Bảng giá răng sứ</a>
                  <a class="dropdown-item" href="">Bảng giá niềng răng</a>
                  <a class="dropdown-item" href="">Bảng giá các dịch vụ khác</a>
                </div>
            </li>
            <li class="nav-item">
