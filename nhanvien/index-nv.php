...
<body class="fixed-sn white-skin">
      ...
      <ul class="custom-scrollbar">
        ...
        <li class="logo-sn waves-effect py-3">
          <div class="text-center">
            <a href="index-bs.php?route=trangcanhan" class="pl-0"><img src="../img/nha-khoa-ident-logo.png"></a>
          </div>
        </li>
                                        ...
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                            <div class="row d-flex justify-content-center align-items-center">
                                              ...
                                              <a type="button" class="btn btn-info btn-sm" onclick="xacnhan(<?php echo $maphieu ?>)">Có, tôi đã nhận đủ</a>
  ...
  <script>
    ...
    function xacnhan(maphieu) {
      ...
      xmlhttp.open("GET", "xacnhanthanhtoan.php?maphieu=" + maphieu, true);
      xmlhttp.send();
    }
